 ...
 * 
 */
@WebServiceClient(name = "StudentWebService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/StudentWebSOAP/StudentWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName STUDENTWEBSERVICE_QNAME = new QName("http://service/", "StudentWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/StudentWebSOAP/StudentWebService?WSDL");
